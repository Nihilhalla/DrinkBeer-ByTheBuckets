...
public class DrunkStatusEffect extends MobEffect {
    ...
    public static void decreaseDrunkStatusEffefct(LivingEntity entity, int amplifier) {
    ...
    public static MobEffectInstance getDecreasedDrunkStatusEffect(int currentAmplifier) {
