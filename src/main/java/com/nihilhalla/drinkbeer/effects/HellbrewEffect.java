...
public class HellbrewEffect extends MobEffect {
    ...
    public static void addStatusEffect( LivingEntity user, int value) {
                MobEffectInstance statusEffectInstance = user.getEffect(MobEffectRegistry.HELLBREW.get());
                ...
                user.addEffect(new MobEffectInstance(MobEffectRegistry.HELLBREW.get(), (BASE_DURATION * (newAmplifier + 1)), newAmplifier));
    }
