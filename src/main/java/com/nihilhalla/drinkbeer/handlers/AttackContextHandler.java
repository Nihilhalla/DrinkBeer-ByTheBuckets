...
public class AttackContextHandler {
  ...
  public AttackContextHandler(LivingEntity attacker, @Nullable Player playerAttacker, InteractionHand hand, Entity target, @Nullable LivingEntity livingTarget, boolean isCritical, float cooldown, boolean isExtraAttack) {
    this(attacker, playerAttacker, hand, EquipmentHandler.getSlotType(hand), target, livingTarget, isCritical, cooldown, isExtraAttack);
  }
