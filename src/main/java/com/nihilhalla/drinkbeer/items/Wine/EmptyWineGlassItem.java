...
import com.nihilhalla.drinkbeer.handlers.EmptyBeerMugHandler;
import com.nihilhalla.drinkbeer.handlers.EmptyWineGlassHandler;
...
public class EmptyWineGlassItem extends BlockItem {
    ...
    public EmptyWineGlassItem(Block block, Properties properties) {
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag nbt) {
        return new EmptyWineGlassHandler(stack);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level worldIn, Player player, InteractionHand hand) {
        ...
        if (stack != null && stack.getItem() == ItemRegistry.EMPTY_WINE_GLASS.get()) {
            ItemStack newStack = new ItemStack(BeerListHandler.buildWineGlassMap(getFluid(stack)));
            stack = newStack;
        }
