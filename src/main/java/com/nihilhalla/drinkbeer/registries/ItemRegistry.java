...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> EMPTY_BEER_MUG = ITEMS.register("empty_beer_mug", () -> new EmptyBeerMugItem(BlockRegistry.EMPTY_BEER_MUG.get(), new Item.Properties()));
    public static final RegistryObject<Item> WHISKY_STILL = ITEMS.register("whisky_still", () -> new BlockItem(BlockRegistry.WHISKY_STILL.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> RECIPE_BOARD_BEER_MUG_HAARS_ICY_PALE_LAGER = ITEMS.register("recipe_board_beer_mug_haars_icy_pale_lager", () -> new BlockItem(BlockRegistry.RECIPE_BOARD_BEER_MUG_HAARS_ICY_PALE_LAGER.get(), new Item.Properties().stacksTo(1)));
    ...
    // NOT FINISHED YET
    // Whisky and Vodka
    public static final RegistryObject<Item> EMPTY_WHISKY_GLASS = ITEMS.register("empty_whisky_glass", () -> new EmptyWhiskyGlassItem(BlockRegistry.EMPTY_WHISKY_GLASS.get(), new Item.Properties()));
    ...
    //Wine and Cognac
    public static final RegistryObject<Item> EMPTY_WINE_GLASS = ITEMS.register("empty_wine_glass", () -> new EmptyWineGlassItem(BlockRegistry.EMPTY_WINE_GLASS.get(), new Item.Properties()));
