...
public class Util {
  public static final Marker DRINKBEER = MarkerManager.getMarker("DRINKBEER");
  ...
  public static Logger getLogger(String type) {
    return LogManager.getLogger(DrinkBeer.MOD_ID + "-" + type);
  }
  ...
  public static Optional<String> getCurrentlyActiveExternalMod() {
    return Optional.ofNullable(ModLoadingContext.get().getActiveContainer().getModId())
      .filter(activeModId -> !DrinkBeer.MOD_ID.equals(activeModId));
  }
  ...
  public static Direction directionFromOffset(BlockPos pos, BlockPos neighbor) {
    ...
    DrinkBeer.LOG.error("No direction for position {} and neighbor {}", pos, neighbor);
