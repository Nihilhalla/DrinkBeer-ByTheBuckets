...
import static com.nihilhalla.drinkbeer.DrinkBeer.getResource;
...
public class FluidTextureProvider extends AbstractFluidTextureProvider {
  ...
  public void addTextures() {
    // basic
    root(FluidRegistry.APPLE_LAMBIC);
    root(FluidRegistry.BLAZE_MILK_STOUT);
    root(FluidRegistry.BLAZE_STOUT);
    root(FluidRegistry.BLAZE_WHISKY);
    root(FluidRegistry.COGNAC);
    root(FluidRegistry.FROTHY_PINK_EGGNOG);
    root(FluidRegistry.HAARS_ICY_PALE_LAGER);
    root(FluidRegistry.MINER_PALE_ALE);
    root(FluidRegistry.NIGHT_HOWL_KVASS);
    root(FluidRegistry.NIGHT_HOWL_WHISKY);
    root(FluidRegistry.PUMPKIN_KVASS);
    root(FluidRegistry.SELTZER);
    root(FluidRegistry.SWEET_BERRY_KRIEK);
    root(FluidRegistry.SWEET_BERRY_WHISKY);
    root(FluidRegistry.VODKA);
    root(FluidRegistry.VODKA_MASH);
    root(FluidRegistry.WHISKY);
    root(FluidRegistry.WINE);
    root(FluidRegistry.WITHER_STOUT);
    root(FluidRegistry.WITHER_WHISKY);
