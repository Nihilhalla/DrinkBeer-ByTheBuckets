...
public class TagEmptyCondition<T> implements ICondition {
  private static final ResourceLocation NAME = DrinkBeer.getResource("tag_empty");
  ...
  @Override
  public boolean test() {
    DrinkBeer.LOG.error("Improperly calling TagEmpty condition for " + tag + ", use context sensitive test method");
    return false;
  }
