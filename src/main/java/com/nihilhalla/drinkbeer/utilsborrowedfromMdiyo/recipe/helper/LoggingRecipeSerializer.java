...
public abstract class LoggingRecipeSerializer<T extends Recipe<?>> extends AbstractRecipeSerializer<T> {
  ...
  public T fromNetwork(ResourceLocation id, FriendlyByteBuf buffer) {
    try {
      ...
      DrinkBeer.LOG.error("{}: Error writing recipe to packet", this.getClass().getSimpleName(), e);
      throw e;
    }
  }
  ...
  public void toNetwork(FriendlyByteBuf buffer, T recipe) {
    try {
      ...
      DrinkBeer.LOG.error("{}: Error reading recipe from packet", this.getClass().getSimpleName(), e);
      throw e;
    }
  }
}
