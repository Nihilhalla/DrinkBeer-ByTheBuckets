...
public class GuiTankModule {
  ...
  private static final Component NO_CAPACITY = new TranslatableComponent(DrinkBeer.makeDescriptionId("gui", "fluid.millibucket"), 0).withStyle(ChatFormatting.GRAY);
  private static final Component TOOLTIP_CAPACITY = new TranslatableComponent(DrinkBeer.makeDescriptionId("gui", "fluid.capacity")).withStyle(ChatFormatting.GRAY);
  private static final Component TOOLTIP_AVAILABLE = new TranslatableComponent(DrinkBeer.makeDescriptionId("gui", "fluid.available")).withStyle(ChatFormatting.GRAY);
