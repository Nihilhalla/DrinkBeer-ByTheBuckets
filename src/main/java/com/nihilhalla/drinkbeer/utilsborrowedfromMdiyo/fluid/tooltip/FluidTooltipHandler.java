...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.SafeClientAccess;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.TooltipKey;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.TagKeySerializer;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.FluidIngredient;
...
public class FluidTooltipHandler extends SimpleJsonResourceReloadListener {
  ...
  public static final Component HOLD_SHIFT = DrinkBeer.makeComponent("gui", "fluid.hold_shift").withStyle(ChatFormatting.GRAY);
  ...
  public static final ResourceLocation DEFAULT_ID = DrinkBeer.getResource("fallback");

  /* Base units */
  private static final FluidUnit BUCKET = new FluidUnit(DrinkBeer.makeDescriptionId("gui", "fluid.bucket"), 1000);
  private static final FluidUnit MILLIBUCKET = new FluidUnit(DrinkBeer.makeDescriptionId("gui", "fluid.millibucket"), 1);
