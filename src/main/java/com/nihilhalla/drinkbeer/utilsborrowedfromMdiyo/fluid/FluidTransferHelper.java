...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.fluid.transfer.FluidContainerTransferManager;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.fluid.transfer.IFluidContainerTransfer;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.fluid.transfer.IFluidContainerTransfer.TransferResult;
...
public class FluidTransferHelper {
  private static final String KEY_FILLED = DrinkBeer.makeDescriptionId("block", "tank.filled");
  private static final String KEY_DRAINED = DrinkBeer.makeDescriptionId("block", "tank.drained");
      ...
      if (simulatedFill > 0) {
        ...
        if (!drainedFluid.isEmpty()) {
          ...
          if (actualFill != drainedFluid.getAmount()) {
            DrinkBeer.LOG.error("Lost {} fluid during transfer", drainedFluid.getAmount() - actualFill);
          }
        }
        return drainedFluid;
      }
