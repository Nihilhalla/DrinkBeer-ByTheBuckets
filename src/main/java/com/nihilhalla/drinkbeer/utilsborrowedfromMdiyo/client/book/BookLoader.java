...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.action.StringActionProcessor;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.action.protocol.ProtocolGoToPage;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.BookData;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentBlank;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentBlockInteraction;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentCrafting;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentImage;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentImageText;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentIndex;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentPadding;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentShowcase;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentSmelting;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentSmithing;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentStructure;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentText;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentTextImage;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentTextLeftImage;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentTextRightImage;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.PageContent;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.deserializer.ConditionDeserializer;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.deserializer.HexStringDeserializer;
...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.transformer.BookTransformer;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.transformer.IndexTransformer;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.data.ResourceLocationSerializer;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.network.MantleNetwork;
...
public class BookLoader implements ResourceManagerReloadListener {
  ...
  public BookLoader() {
    ...
    StringActionProcessor.registerProtocol(DrinkBeer.getResource("go-to-page"), new ProtocolGoToPage(false));
    StringActionProcessor.registerProtocol(DrinkBeer.getResource("go-to-page-rtn"), new ProtocolGoToPage(true));
