...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.screen.book.ArrowButton;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.screen.book.BookScreen;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.screen.book.element.AnimationToggleElement;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.screen.book.element.BookElement;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.screen.book.element.StructureElement;
...
public class ContentStructure extends PageContent {
  ...
  public static final transient ResourceLocation ID = DrinkBeer.getResource("structure");
  ...
  public void load() {
    ...
    for (int i = 0; i < this.templateBlocks.size(); i++) {
      ...
      if (info.state == Blocks.AIR.defaultBlockState()) {
        ...
        DrinkBeer.LOG.error("Found non-default air block in template " + this.data);
    }
  }
