...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.BookLoadException;
...
import static com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.screen.book.Textures.TEX_CRAFTING;

public class ContentCrafting extends PageContent {
  public static final ResourceLocation ID = DrinkBeer.getResource("crafting");
