...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.BookLoader;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.repository.FileRepository;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.FallbackModelLoader;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.NBTKeyModel;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.RetexturedModel;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.connected.ConnectedModel;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.fluid.FluidTextureModel;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.fluid.FluidsModel;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.inventory.InventoryModel;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.util.ColoredBlockModel;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.util.MantleItemLayerModel;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.model.util.ModelHelper;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.fluid.tooltip.FluidTooltipHandler;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.registration.MantleRegistrations;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.registration.RegistrationHelper;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.OffhandCooldownTracker;
...
public class ClientEvents {
  ...
  static void clientSetup(FMLClientSetupEvent event) {
    ...
    BookLoader.registerBook(DrinkBeer.getResource("test"), new FileRepository(DrinkBeer.getResource("books/test")));
  }

  @SubscribeEvent
  static void registerModelLoaders(ModelRegistryEvent event) {
    // standard models - useful in resource packs for any model
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("connected"), ConnectedModel.Loader.INSTANCE);
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("item_layer"), MantleItemLayerModel.LOADER);
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("colored_block"), ColoredBlockModel.LOADER);
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("fallback"), FallbackModelLoader.INSTANCE);

    // NBT dynamic models - require specific data defined in the block/item to use
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("nbt_key"), NBTKeyModel.LOADER);
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("retextured"), RetexturedModel.Loader.INSTANCE);

    // data models - contain information for other parts in rendering rather than rendering directly
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("fluid_texture"), FluidTextureModel.LOADER);
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("inventory"), InventoryModel.Loader.INSTANCE);
    ModelLoaderRegistry.registerLoader(DrinkBeer.getResource("fluids"), FluidsModel.Loader.INSTANCE);
  }
