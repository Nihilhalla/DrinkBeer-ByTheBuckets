package com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.action;

import net.minecraft.resources.ResourceLocation;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.action.protocol.ActionProtocol;
