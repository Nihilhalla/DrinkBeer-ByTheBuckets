...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentSectionList;
...
public class IndexTransformer extends BookTransformer {
  ...
  public static final ResourceLocation INDEX_EXTRA_DATA = DrinkBeer.getResource("index");
