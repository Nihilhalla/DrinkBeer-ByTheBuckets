...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.transformer.ContentListingSectionTransformer;
...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.screen.book.element.ListingLeftElement;
  ...
  public void addColumnBreak() {
    if (!this.entries.get(this.entries.size() - 1).isEmpty()) {
      if (this.entries.size() == 3) {
        DrinkBeer.LOG.warn("Too many columns in content listing, you should create a second listing instead");
      }
