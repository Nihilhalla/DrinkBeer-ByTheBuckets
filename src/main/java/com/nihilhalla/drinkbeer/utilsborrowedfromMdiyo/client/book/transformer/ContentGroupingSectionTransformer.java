...
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.PageData;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.SectionData;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentListing;
import com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.client.book.data.content.ContentPadding.ContentRightPadding;
...
public class ContentGroupingSectionTransformer extends SectionTransformer {
  private static final ResourceLocation INDEX_EXTRA_DATA = DrinkBeer.getResource("index");
