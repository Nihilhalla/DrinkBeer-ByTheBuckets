...
/**
 * Interface for containers that can be renamed. Used in {@link com.nihilhalla.drinkbeer.utilsborrowedfromMdiyo.block.InventoryBlock} to set the name on placement
 */
